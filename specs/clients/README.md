...
Client specs define first-party user experience and rendering behavior. They
consume AppServer and Session Core contracts without redefining server-side
domain semantics.
