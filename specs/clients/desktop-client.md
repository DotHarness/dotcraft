...
- App-bound Dynamic Tools may provide declarative Tool Result Presentation payloads. Desktop renders them only through trusted local renderers declared in [Tool Result Presentation](../protocols/tool-result-presentation.md).
