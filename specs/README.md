...
4. [Desktop Client](clients/desktop-client.md) and [Desktop DESIGN.md](architecture/DESIGN.md) for first-party client behavior and shared Desktop visual rules.
