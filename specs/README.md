...
- Architecture: [session-core.md](architecture/session-core.md), [runtime-module-boundaries.md](architecture/runtime-module-boundaries.md), [context-compaction.md](architecture/context-compaction.md), [tools-architecture.md](architecture/tools-architecture.md), [prompt-composition.md](architecture/prompt-composition.md), [prompt-cache.md](architecture/prompt-cache.md), [responses-provider-history.md](architecture/responses-provider-history.md), [model-runtime.md](architecture/model-runtime.md), [hub-architecture.md](architecture/hub-architecture.md), [plugin-architecture.md](architecture/plugin-architecture.md), [plugin-registry.md](architecture/plugin-registry.md), [skill-2.0.md](architecture/skill-2.0.md), [lsp-plugin.md](architecture/lsp-plugin.md), [DESIGN.md](architecture/DESIGN.md), [openai-subscription-auth.md](architecture/openai-subscription-auth.md)
