...
>   `ThreadAccessCoordinator`, `ThreadConfigurationCoordinator`, `TurnControlCoordinator`, and
>   `ThreadGoalCoordinator` are extracted. Continue with queue/maintenance clusters before the
