...
>   `ThreadIndexCoordinator`, `ThreadCreationCoordinator`, `ThreadLifecycleCoordinator`, and
>   `ThreadAccessCoordinator` are extracted. Continue with low-coupling clusters before the
