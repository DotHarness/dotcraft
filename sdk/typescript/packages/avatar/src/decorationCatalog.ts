...
export const decorations: Decoration[] = [
  ...
  {"id":"task-board","name":"Task board","category":"Accessories","feature":"Cream board, short clip, two lines and a checkbox","colors":["#f3e7cc","#85989e","#7c887d"],"mount":"Left-hand grip; stowed for laptop and question sign, then restored"},
  {"id":"wrench","name":"Wrench","category":"Accessories","feature":"Silver open-ended wrench with a short shaded handle","colors":["#aebcc8","#708796"],"mount":"Left-hand grip; stowed for laptop and question sign, then restored"},
  {"id":"shield","name":"Shield","category":"Accessories","feature":"Rounded blue shield with a white check","colors":["#7198b2","#547c99","#ffffff"],"mount":"Left-hand grip; stowed for laptop and question sign, then restored"},
  {"id":"magnifier","name":"Magnifier","category":"Accessories","feature":"Dark round frame, blue translucent lens and short handle","colors":["#526a7d","#adcfdc"],"mount":"Left-hand grip; stowed for laptop and question sign, then restored"},
  {"id":"control-panel","name":"Control panel","category":"Accessories","feature":"Dark rounded shell, two rails and colored knobs","colors":["#475a70","#8acbbb","#f0c86b"],"mount":"Left-hand grip; stowed for laptop and question sign, then restored"},
]
