...
export const decorationMotionProfiles: Record<HeadId, MotionProfile> = {
  ...
  'floppy-disk': lift(), rocket: { ...lift(), shadow: 60 },
  'cat-ears': fitted(), 'shark-fin': fitted(), 'propeller-cap': fitted(), 'flower-crown': fitted(), 'crystal-cluster': fitted(), 'mini-volcano': fitted(),
  mushroom: bounce(), 'ice-cream': bounce(),
  poop: bounce(), 'rubber-duck': bounce(520), 'phoenix-perch': bounce(522), donut: { ...bounce(), shadow: 40 },
