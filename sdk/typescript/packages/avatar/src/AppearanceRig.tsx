...
export function AppearanceRig({ appearance, pose, expression: override, top, accessory }: {
  appearance: Appearance; pose: AvatarPose; expression?: AvatarExpression; top?: ReactNode; accessory?: ReactNode
}) {
  ...
  return <MascotRig size={1024} expression={expression} top={top} accessory={accessory}
