...
export interface ClientRequestMethods {
  ...
  "automation/list": { params: Models.RpcEmpty; result: Models.AutomationListResult };
  "automation/presets/list": { params: Models.AutomationPresetsParams; result: Models.AutomationPresetsResult };
