    ...
    ILogger<AutoReviewDispatchService> logger)
{
    ...
    private static AutoReviewProject? ParseAutoReviewProject(string value)
    {
        ...
        if (global::DotCraft.Oratorio.Sources.SourceProjectKey.TryParse(normalized, out var key))
        {
        ...
        var repository = global::DotCraft.Oratorio.Sources.SourceProjectKey.NormalizeGitHubRepository(normalized);
