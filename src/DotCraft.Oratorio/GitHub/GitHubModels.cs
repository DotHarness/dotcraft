...
public sealed record GitHubSyncItem(
    ...
    bool IsDraft,
    string? HeadSha,
    global::DotCraft.Oratorio.Domain.SourceState SourceState,
...
{
    Task SetPhaseAsync(global::DotCraft.Oratorio.Domain.GitHubSyncRepositoryPhase phase, CancellationToken ct);
