...
internal static class EventPresentationFactory
{
    ...
    private static EventDescription Describe(TraceEvent e, TraceEvent? start, TraceMetadata metadata) => e.Type switch
    {
        ...
        TraceEventType.Error => new("Runtime error", Preview(e.Content), "Error", TimelineLane.Runtime, false, true, "Error"),
        TraceEventType.ProviderError => new("Provider error", Preview(e.Content), "Error", TimelineLane.Model, false, true, "Error"),
        TraceEventType.TurnCompleted => new("Turn completed", Duration(e.DurationMs), "Turn", TimelineLane.Runtime, false, false, null),
        TraceEventType.SessionMetadata => new("Session context", Changed(e), "Context", TimelineLane.Runtime, true, false, null),
        TraceEventType.ToolInjection => new("Tools changed", Join(e.ChangedToolNames ?? e.ToolNames), "Runtime", TimelineLane.Runtime, false, false, null),
        TraceEventType.DeferredToolLoading => new("Deferred tools activated", metadata.Get("trigger", "strategy", "effectiveMode") ?? Preview(e.Content), "Runtime", TimelineLane.Runtime, false, false, null),
        TraceEventType.SkillReferenced => new("Skill referenced", e.ToolName ?? Preview(e.Content), "Runtime", TimelineLane.Runtime, false, false, null),
        TraceEventType.ContextCompaction => new("Context compacted", Preview(e.Content), "Maintenance", TimelineLane.Runtime, false, false, "Summary"),
        TraceEventType.MaintenanceForkRequest => new("Maintenance request", e.ToolName ?? metadata.Get("taskKind") ?? Preview(e.Content), "Maintenance", TimelineLane.Runtime, false, false, "Prompt"),
        TraceEventType.MaintenanceForkResponse => new("Maintenance response", Preview(e.Content), "Maintenance", TimelineLane.Runtime, false, false, "Response"),
        TraceEventType.ThreadRollback => new("Thread rollback", Preview(e.Content), "Maintenance", TimelineLane.Runtime, false, false, "Summary"),
        ...
        TraceEventType.SubAgentPrefixDiagnostic => new("Sub-agent prefix", metadata.Get("status") ?? "Prefix comparison", "Diagnostic", TimelineLane.Runtime, true, false, null),
        _ => new(SplitName(e.Type.ToString()), Preview(e.Content), "Runtime", TimelineLane.Runtime, false, false, "Content"),
    };
