...
{    public static readonly RpcRequest<AppBindingActivateParams, AppBinding> AppBindingActivate = new("app/binding/activate", RpcDirection.ClientToServer, "1", "specs/protocols/app-binding.md", module: "app-binding", scope: "connection", capability: "appBindingVersion:1", errors: CommonErrors);
    ...
    public static readonly RpcRequest<AcpTerminalKillParams, global::DotCraft.Protocol.RpcEmpty> ExtAcpTerminalKill = new("ext/acp/terminal/kill", RpcDirection.ServerToClient, "1", "specs/protocols/appserver-protocol.md", module: "acp", scope: "connection", capability: "acpExtensions", errors: CommonErrors);

    public static readonly RpcRequest<AcpTerminalReleaseParams, global::DotCraft.Protocol.RpcEmpty> ExtAcpTerminalRelease = new("ext/acp/terminal/release", RpcDirection.ServerToClient, "1", "specs/protocols/appserver-protocol.md", module: "acp", scope: "connection", capability: "acpExtensions", errors: CommonErrors);
    ...
    public static readonly RpcRequest<global::DotCraft.Protocol.RpcEmpty, global::DotCraft.Protocol.RpcEmpty> ExtChannelHeartbeat = new("ext/channel/heartbeat", RpcDirection.ServerToClient, "1", "specs/protocols/external-channel-adapter.md", module: "external-channel", scope: "connection", capability: "channelAdapter", errors: CommonErrors);
    ...
    public static readonly RpcRequest<NodeReplCancelParams, global::DotCraft.Protocol.RpcEmpty> ExtNodeReplCancel = new("ext/nodeRepl/cancel", RpcDirection.ServerToClient, "1", "specs/protocols/appserver-protocol.md", module: "node-repl", scope: "connection", capability: "nodeRepl", errors: CommonErrors);
