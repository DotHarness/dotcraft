...
internal sealed class ThreadMetadataStore(WorkspaceStateDatabase stateRuntime)
{
        ...
        while (reader.Read())
        {
            ...
            list.Add(new ThreadSummary
            {
                ...
                Source = reader.IsDBNull(14)
                    ? throw new InvalidDataException($"Thread '{reader.GetString(0)}' has no source projection.")
