        ...
        DateTimeOffset? timestamp = null)
    {
        ...
        var shapeEvent = new TraceEvent
        {
            ...
            MetadataJson = SerializeMetadata(new
            {
                ...
                inputItemIdEligibleCount = snapshot.InputItemIdEligibleCount,
                inputItemIdPresentCount = snapshot.InputItemIdPresentCount,
                inputItemIdGeneratedCount = snapshot.InputItemIdGeneratedCount,
                inputItemIdMissingCount = snapshot.InputItemIdMissingCount,
                inputItemIdInvalidSourceCount = snapshot.InputItemIdInvalidSourceCount,
