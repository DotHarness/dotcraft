    ...
    SkillVariantTarget? skillVariantTarget = null)
{
    ...
    public SessionInputMaterializationResult MaterializeNormalized(IReadOnlyList<SessionInputPart> input)
    {
        var nativeParts = input.ToList();
        var materializedParts = new List<SessionInputPart>();
    ...
    internal static List<SessionInputPart> NormalizeInputParts(IReadOnlyList<SessionInputPart> input)
    {
        var normalized = new List<SessionInputPart>(input.Count);
    ...
    private IEnumerable<SessionInputPart> MaterializePart(SessionInputPart part)
    {
        switch (part.Type)
        {
            case "commandRef":
