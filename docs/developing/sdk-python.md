...
| Example | Description |
|---------|-------------|
| [examples/telegram/](./channels/python-telegram.md) | Reference Telegram adapter using long polling, inline keyboard approvals, and delivery support. |

## Further Reading

- [ARCHITECTURE.md](https://github.com/DotHarness/dotcraft/blob/master/sdk/python/ARCHITECTURE.md) — How the SDK works internally.
- [AppServer Protocol](./appserver-protocol.md) — JSON-RPC client protocol overview.
