...
- Use [security configuration](./security.md) to forbid the agent from writing outside the workspace.

## Related

- [Project Workspace](./workspace.md)
- [Skills & Self-Learning](./skills.md)
- [Observability](./observability.md)
- [Configuration Reference](../developing/configuration.md) for `Memory.*` and `Compaction.*` fields
