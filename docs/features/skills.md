...
When skill self-learning is enabled, DotCraft exposes a managed skill-editing capability so the agent can create, patch, and maintain workspace skills after successful work. Creation and destructive changes go through approval, and full limits are listed in the [Configuration Reference](../developing/configuration.md#workspace-memory-and-skills).
...
| Distributable capability bundle (skills + tools) | Build a [Plugin](./plugins-tools.md) |
...
- [Plugins & Tools](./plugins-tools.md) — distributing skills + tools as plugins
- [Project Workspace](./workspace.md) — where `.craft/skills/` sits
- [Samples](../resources/samples.md) — `dev-guide`, `feature-workflow`, copy-and-adapt templates
