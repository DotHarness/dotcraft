...
public sealed class ContractKernelTests
{
    ...
    public void Catalog_Covers_The_Complete_Core_Surface()
    {
        ...
        Assert.Equal(192, core.Length);
        Assert.Equal(145, core.Count(static descriptor => descriptor is { Kind: "request", Direction: RpcDirection.ClientToServer }));
