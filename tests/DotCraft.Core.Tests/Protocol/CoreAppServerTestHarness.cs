...
/// <see cref="CoreTestableSessionService"/>, <see cref="AppServerConnection"/>,
...
/// </summary>
internal sealed class CoreAppServerTestHarness : IDisposable
{
    private readonly string _tempDir;

    public InMemoryTransport Transport { get; }
    public CoreTestableSessionService Service { get; }
    ...
    public CoreAppServerTestHarness(
        ...
        IChannelStatusProvider? channelStatusProvider = null)
    {
        ...
        Service = new CoreTestableSessionService(store);
