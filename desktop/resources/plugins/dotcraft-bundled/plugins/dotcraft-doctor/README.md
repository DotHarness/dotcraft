...
- `dotcraft-doctor` — route broad troubleshooting requests to the focused diagnosis, context handoff, or issue reporting workflow.
- `error-diagnosis` — correlate Hub or workspace operational logs with local state, traces, and thread rollout evidence, read-only.
