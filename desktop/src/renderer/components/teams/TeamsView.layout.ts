export const TEAM_AVATAR_URLS: Record<string, string> = {
  leader: new URL('../../assets/teams/team-leader.svg', import.meta.url).toString(),
  explorer: new URL('../../assets/teams/team-explorer.svg', import.meta.url).toString(),
  builder: new URL('../../assets/teams/team-builder.svg', import.meta.url).toString(),
  reviewer: new URL('../../assets/teams/team-reviewer.svg', import.meta.url).toString(),
  operator: new URL('../../assets/teams/team-operator.svg', import.meta.url).toString()
}
