...
export type ProviderMarkKind = 'anthropic' | 'openai'
...
export function ProviderMark({
  ...
  return (
    <svg
      ...
      focusable="false"
      height={size}
      style={providerMarkStyle(size, style)}
      viewBox="0 0 24 24"
      width={size}
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d={kind === 'anthropic' ? ANTHROPIC_PATH : OPENAI_PATH} />
    </svg>
  )
}

function providerMarkStyle(size: number, style?: CSSProperties): CSSProperties {
  return {
    width: size,
    height: size,
    display: 'block',
