...
import { normalizeProviderProtocol } from '../shared/providerProtocols'
import {
...
export interface WorkspaceSetupResult extends WorkspaceSetupRunResult {
  stdout: string
  stderr: string
  exitCode: number
}
